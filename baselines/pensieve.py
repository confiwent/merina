...
LOG_FILE_OBE = '../Results/test/oboe/log_test_a3c'
LOG_FILE_3GP = '../Results/test/3gp/log_test_a3c'
LOG_FILE_FCC = '../Results/test/fcc/log_test_a3c'
LOG_FILE_FH = '../Results/test/fh/log_test_a3c'
LOG_FILE_GHT = '../Results/test/ghent/log_test_a3c'
LOG_FILE_FHN = '../Results/test/fh_noisy/log_test_a3c'
LOG_FILE_PUF = '../Results/test/puffer/log_test_a3c'
LOG_FILE_PUF2 = '../Results/test/puffer2/log_test_a3c'
LOG_FILE_PWI = '../Results/test/pubwifi/log_test_a3c'
LOG_FILE_INT = '../Results/test/intern/log_test_a3c'
...
LOG_FILE_GHT_LOG = '../Results/test/log/ghent/log_test_a3c'
LOG_FILE_FHN_LOG = '../Results/test/log/fh_noisy/log_test_a3c'
LOG_FILE_PUF_LOG = '../Results/test/log/puffer/log_test_a3c'
LOG_FILE_PUF2_LOG = '../Results/test/log/puffer2/log_test_a3c'
LOG_FILE_PWI_LOG = '../Results/test/log/pubwifi/log_test_a3c'
LOG_FILE_INT_LOG = '../Results/test/log/intern/log_test_a3c'
